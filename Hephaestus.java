...
public class Hephaestus extends NPC{
    ...
    public Hephaestus(int x, int y) {
        ...
        before.add("*grunts*/n Hey kid./nIf we’re travelling by ship we need~to give an offering for safe travel./nYou’ll need to go to sacrifice fish to~Poseidon.I think his statue should be near the~entrance to the mines.");
