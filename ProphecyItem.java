/**
    ProphecyItem Class that extends SuperItem and contains the item name and a load method for the image. Also determines whether an 
...
public class ProphecyItem extends SuperItem {
    ...
    public ProphecyItem(){ //Constructor determines the size of the entity drawn in inventory and whether it is stackable
